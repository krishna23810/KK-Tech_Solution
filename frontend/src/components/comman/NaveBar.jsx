...
const NavBar = () => {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 h-[80px] flex items-center justify-center bg-gray-600 border-b-2 border-gray-500 z-50">
                ...
                <div className='flex space-x-4 relative'>
                    ...
                    }
                    {
                        ...
                        <button onClick={profileDropDown}> 
                            <img src={profilePic} alt="Profile" className='w-14 h-8 left-11 -top-0 absolute rounded-full object-cover' />
                        </button>
